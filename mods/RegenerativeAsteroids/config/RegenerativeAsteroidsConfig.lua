...
RegenerativeAsteroidsConfig.frequency = 700; -- 0 to 1000, probability of this sector to appear. Keep around 300 to be average with other similiar sectors.
...
RegenerativeAsteroidsConfig.MinableAsteroidLimit = 250; -- number of asteroids to maintain in the sector.
RegenerativeAsteroidsConfig.SectorGenerator = false; -- true or false, true will allow for random sectors to be regenerative asteroid fields.  use false if you want to have this script run only in SPECIFIC  sectors using the /regen command
