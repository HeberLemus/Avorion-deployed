...
function TraderAttackedByPirates.initialize()
    ...
    reputation = reward * 8000
    reward = reward * 75000 * Balancing_GetSectorRichnessFactor(Sector():getCoordinates())
...
function TraderAttackedByPirates.endEvent()
    ...
    --need to make way for trader ship to jump at event end
